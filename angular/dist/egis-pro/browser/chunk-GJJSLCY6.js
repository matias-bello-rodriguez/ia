...
function VisadoComponent_Conditional_38_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.statusClass(f_r1.status));
    \u0275\u0275advance();
...
function VisadoComponent_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, VisadoComponent_Conditional_38_For_2_Template, 10, 5, "div", 31, _forTrack1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function VisadoComponent_For_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30)(1, "div", 49);
    \u0275\u0275element(2, "i", 50);
    \u0275\u0275elementStart(3, "div")(4, "div", 51);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.statusClass(doc_r3.status));
    \u0275\u0275advance();
...
var MOCK_RESULTS = [
  ...
  { label: "Fecha Emisi\xF3n", value: "15/01/2026", status: "approved" },
  { label: "Vigencia", value: "15/04/2026", status: "approved" },
  { label: "Dominio Vigente", value: "Emitido hace 95 d\xEDas", status: "rejected", note: "Documento > 90 d\xEDas, solicitar actualizaci\xF3n en el CBR" },
  { label: "Monto Ahorro", value: "12 UF", status: "alert", note: "Ahorro insuficiente - m\xEDnimo requerido: 15 UF" }
];
var DOC_QUEUE = [
...
var VisadoComponent = class _VisadoComponent {
  constructor() {
    this.extractionResults = MOCK_RESULTS;
    this.documentQueue = DOC_QUEUE;
    this.vigenciaFilter = "todos";
    this.isScanning = false;
    this.showResults = true;
  }
  get filteredQueue() {
    if (this.vigenciaFilter === "todos")
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VisadoComponent, selectors: [["app-visado"]], decls: 63, vars: 6, consts: [[1, "d-flex", "flex-column", "gap-4"], [1, "row", "g-4"], [1, "col-12", "col-lg-6"], [1, "card", "mb-3"], [1, "card-header"], [1, "mb-0"], [1, "text-body-secondary"], [1, "card-body"], ["tabindex", "0", "role", "button", 1, "border", "border-2", "border-primary", "border-opacity-25", "rounded", "bg-primary", "bg-opacity-10", "d-flex", "flex-column", "align-items-center", "justify-content-center", "gap-3", "p-4", "cursor-pointer", 2, "min-height", "200px", 3, "click", "keydown.enter"], [1, "bi", "bi-upload", "display-6", "text-primary"], [1, "mb-0", "fw-medium"], [1, "card"], [1, "bg-light", "rounded", "d-flex", "flex-column", "align-items-center", "justify-content-center", "gap-2", 2, "min-height", "200px"], [1, "bi", "bi-eye", "text-body-secondary"], [1, "small", "text-body-secondary"], [1, "small", "font-monospace"], [1, "card-header", "d-flex", "justify-content-between", "align-items-center"], [1, "d-flex", "align-items-center", "gap-2"], [1, "bi", "bi-robot", "text-primary"], [1, "btn", "btn-sm", "btn-outline-primary", 3, "click", "disabled"], [1, "bi", "bi-upc-scan", "me-1"], [1, "d-flex", "flex-column", "gap-2"], [1, "d-flex", "flex-column", "align-items-center", "justify-content-center", "gap-3", "text-body-secondary", 2, "min-height", "200px"], [1, "card-header", "d-flex", "flex-column", "flex-sm-row", "justify-content-between", "align-items-start", "gap-2"], [1, "bi", "bi-calendar-check", "text-body-secondary"], [1, "form-select", "form-select-sm", 2, "width", "180px", 3, "ngModelChange", "ngModel"], ["value", "todos"], ["value", "vigente"], ["value", "por_vencer"], ["value", "vencido"], [1, "d-flex", "align-items-center", "justify-content-between", "border", "rounded", "p-3"], [1, "border", "rounded", "p-3"], [1, "d-flex", "justify-content-between", "align-items-start"], [1, "fw-medium"], [1, "badge", 3, "ngClass"], [1, "mt-2", "small", "rounded", "p-2", 3, "bg-danger", "bg-opacity-10", "text-danger", "bg-warning", "text-warning"], [1, "mt-2", "small", "rounded", "p-2"], [1, "spinner-border", "text-primary"], [1, "row", "g-2", "text-center"], [1, "col-4"], [1, "rounded", "p-3", "bg-success", "bg-opacity-10"], [1, "bi", "bi-check-circle", "text-success"], [1, "fw-bold", "text-success"], [1, "rounded", "p-3", "bg-danger", "bg-opacity-10"], [1, "bi", "bi-x-circle", "text-danger"], [1, "fw-bold", "text-danger"], [1, "rounded", "p-3", "bg-warning", "bg-opacity-10"], [1, "bi", "bi-exclamation-circle", "text-warning"], [1, "fw-bold", "text-warning"], [1, "d-flex", "align-items-center", "gap-3"], [1, "bi", "bi-file-pdf", "text-body-secondary"], [1, "fw-medium", "font-monospace", "small"]], template: function VisadoComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(58, "Vencidos");
        \u0275\u0275elementEnd()()()();
        \u0275\u0275elementStart(59, "div", 7)(60, "div", 21);
        \u0275\u0275repeaterCreate(61, VisadoComponent_For_62_Template, 10, 4, "div", 30, _forTrack0);
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(13);
        ...
        \u0275\u0275advance(11);
        \u0275\u0275repeater(ctx.filteredQueue);
      }
    }, dependencies: [CommonModule, NgClass, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, SelectControlValueAccessor, NgControlStatus, NgModel], encapsulation: 2 });
  }
};
(() => {
    ...
    <div class="col-12 col-lg-6">\r
      <div class="card mb-3">\r
        <div class="card-header d-flex justify-content-between align-items-center">\r
          ...
          <button class="btn btn-sm btn-outline-primary" (click)="scan()" [disabled]="isScanning">\r
              ...
              @for (f of extractionResults; track f.label) {\r
                <div class="border rounded p-3">\r
                  <div class="d-flex justify-content-between align-items-start">\r
                    ...
                    <span class="badge" [ngClass]="statusClass(f.status)">{{ statusLabel(f.status) }}</span>\r
                  </div>\r
                  @if (f.note) {\r
  ...
  <div class="card">\r
    <div class="card-header d-flex flex-column flex-sm-row justify-content-between align-items-start gap-2">\r
      ...
      <div class="d-flex align-items-center gap-2">\r
        ...
        <select class="form-select form-select-sm" style="width: 180px;" [(ngModel)]="vigenciaFilter">\r
    ...
    <div class="card-body">\r
      <div class="d-flex flex-column gap-2">\r
        @for (doc of filteredQueue; track doc.name) {\r
          <div class="d-flex align-items-center justify-content-between border rounded p-3">\r
            ...
            <span class="badge" [ngClass]="statusClass(doc.status)">{{ statusLabel(doc.status) }}</span>\r
          </div>\r
        }\r
      </div>\r
    </div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VisadoComponent, { className: "VisadoComponent", filePath: "src/app/features/visado/visado.component.ts", lineNumber: 45 });
})();
export {
  VisadoComponent
};
//# sourceMappingURL=chunk-GJJSLCY6.js.map
